...
for infRate = infRate_list
    ...
    for infNum = infNum_list 
        ...
        for muteRate = mute_list
            ...
            num_infected_ave(mut_idx,:) = nanmean(infected_tmp + rec_tmp,1)./N; % normaizled to 0-1
            num_infected_std(mut_idx,:) = nanstd(double(infected_tmp+rec_tmp),1)./N;  % normaizled to 0-1
