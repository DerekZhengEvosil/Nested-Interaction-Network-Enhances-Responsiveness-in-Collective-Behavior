...
load("../data/SIR_data/R0_outdata.mat")
figure
figSize_L = 5;
figSize_W = 4.5;
...
for muteRate = draw_mute_list
    ...
    hold on
    e(mute_idx) = plot(flip_R0([1:1:stop_idx, stop_idx]), ave_final_infected_data{cnt} , ...
        'Color',mycolor(mute_idx,:),'LineWidth',2,'Marker','none','LineStyle','-','MarkerSize',10);
    hold on
    fill([flip_R0, fliplr(flip_R0)], [fliplr(high_CI_tmp_cell{cnt}'), low_CI_tmp_cell{cnt}'], ...
