...
for infRate = infRate_list
    for infNum = infNum_list 
        ...
        for muteRate = mute_list
            ...
            infected_tmp = num_infected{1,mut_idx};
            rec_tmp = num_rec{1, mut_idx};
            num_infected_ave(mut_idx,:) = nanmean(infected_tmp + rec_tmp,1)./N; % normalized to 0-1
            num_infected_std(mut_idx,:) = nanstd(double(infected_tmp+rec_tmp),1)./N; % normalized to 0-1
