...
addpath("../utility/")
load("../data/SIR_data/high_CI_Fig2g.mat")
load("../data/SIR_data/lower_CI_Fig2g.mat")
N = 100;
...
N = 100;
dataFolder = "../data/SIR_data/result_N=100_th=0.3";
load("../data/SIR_data/lower_CI_Fig2e.mat")
load("../data/SIR_data/high_CI_Fig2e.mat")
...
clear;clc;
dataFolder = "../data/SIR_data/result_N=100_th=0.3";
load("../data/SIR_data/lower_CI_Fig2f.mat");
load("../data/SIR_data/high_CI_Fig2f.mat")
infRate_list = [0.3:0.1:0.5];
recRate = 0.05;
infNum_list = [1];
mute_list = [0:0.1:1];
