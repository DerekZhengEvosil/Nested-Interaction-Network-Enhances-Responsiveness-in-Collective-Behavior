...
[rho,pval] = corr(draw_M_index',draw_op',"type","Spearman")
g(1,1)=gramm('x',(draw_op));
...
g(2,1)=gramm('x',draw_op,'y',draw_M_index,'color',draw_op);
...
[rho,pval] = corr(draw_U_turn_NODF',draw_op',"type","Spearman")
%Create a scatter plot
...
figSize_W = 3.5;
set(gcf,'Units','centimeter','Position',[5 5 figSize_L figSize_W]);
[rho,pval] = corr(draw_U_turn_NODF',draw_M_index',"type","Spearman")
%Create a scatter plot
