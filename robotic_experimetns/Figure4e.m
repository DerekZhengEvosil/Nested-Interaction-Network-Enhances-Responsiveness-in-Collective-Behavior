% This MATLAB code generates a violin plot that visualizes the distribution of the mean curvature data collected from the collective hovering experiments.
clear;clc;
addpath("../utility/")
